...
public class Person {
	...
	public static List<Person> createRoster() {
		...
		roster.add(new Person("Quinn",		"Eskimo",		"PHP programmer",   IsoChronology.INSTANCE.date(1980, 9,   5),  Person.Sex.FEMALE,  "Quinn@example.com"));
		roster.add(new Person("Ros",		"Line",			"PHP programmer",   IsoChronology.INSTANCE.date(2007, 9,   3),  Person.Sex.FEMALE,  "Ros@example.com"));
		roster.add(new Person("Sam",		"Spade",		"PHP programmer",   IsoChronology.INSTANCE.date(2005, 12,  2),  Person.Sex.FEMALE,  "Tori@example.com"));
		...
		roster.add(new Person("Vere",		"Hervey",		"Java programmer",  IsoChronology.INSTANCE.date(2005, 6,   4),  Person.Sex.MALE,    "Vere@example.com"));
